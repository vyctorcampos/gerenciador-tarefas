...
@Component({
  ...
  template: `
    <div class="card">
      ...
      <form [formGroup]="tarefaForm" (ngSubmit)="cadastrarTarefa()">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <select id="situacao" formControlName="situacao" class="form-control">
              ...
              <option [value]="Situacao.CONCLUIDA">Concluida</option>
            </select>
        ...
        <div class="form-actions">
          ...
          <button type="submit" class="btn btn-primary" [disabled]="tarefaForm.invalid">Cadastrar</button>
        </div>
      </form>
    </div>
  `,
