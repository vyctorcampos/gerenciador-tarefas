...
DROP TABLE IF EXISTS tarefa.tarefa CASCADE;
DROP TABLE IF EXISTS tarefa.users CASCADE;
...
INSERT INTO tarefa.users (id, login, password, role) 
VALUES (uuid_generate_v4(), 'admin', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDa', 'WRITE')
